...
class ResultsLapData extends Request
{
     ...
     * @return String
     */
    public function getJSON(int $subsession_id, int $simsession_number, int $cust_id = 0, int $team_id = 0, bool $addChunkcontent = true)
    :String
    {
     ...
     */
    public function getArray(int $subsession_id, int $simsession_number, int $cust_id = 0, int $team_id = 0, bool $addChunkcontent = true)
    :array
    {
