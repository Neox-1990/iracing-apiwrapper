...
/**
 * Returns all divisions and their ids
 */
class ConstantsDivisions extends Request
{
    /**
    ...
    :String
    {
        $json = $this->perform("https://members-ng.iracing.com/data/constants/divisions", [])->getResponse();
